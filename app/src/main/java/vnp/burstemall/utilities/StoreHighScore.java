...
public class StoreHighScore {
    ...
    private static final String MUSIC_TURNED = "musicTurned";
    ...
    public static boolean getMusicValue(Context context) {
        return getPreferences(context).getBoolean(MUSIC_TURNED, true);
    }
    public static void setMusicValue(Context context, boolean value) {
        SharedPreferences.Editor editor = getPreferences(context).edit();
        editor.putBoolean(MUSIC_TURNED, value);
        editor.apply();
    }
